    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 items-center justify-center p-8">
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-4">Design Systems Visually</h2>
          <p className="text-xl opacity-90 mb-8">
            Just say "Design Twitter" and watch the architecture come to life.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">Start designing systems in minutes</p>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-300 rounded-xl text-gray-700 font-medium hover:bg-gray-50 transition shadow-sm"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
